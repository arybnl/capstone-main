...
<head>
    ...
    <link rel="stylesheet" href="HealthHistory.css">
...
<body class="body">
  ...
  <!-- Toggle button -->
    ...
    <!---------------------------- Main Container for HEALTH HISTORY ------------------------------->
    ...
    <div class="content-wrapper">
       <div class="main-container">
        ...
        <div class="header-bar">
            <span class="header-title">Health Assessment History</span>
        ...
        <div class="history-list" id="historyList">
            ...
            <div class="history-item" data-id="1">
                <span class="history-info">Annual Physical Exam</span>
                <div class="history-right">
                    <span class="history-date history-info">2024-06-01</span>
                    <button class="archive-btn" data-bs-toggle="modal" data-bs-target="#archiveModal" data-id="1">
            ...
            <div class="history-item" data-id="2">
                <span class="history-info">Blood Pressure Check</span>
                <div class="history-right">
                    <span class="history-date history-info">2024-05-15</span>
                    <button class="archive-btn" data-bs-toggle="modal" data-bs-target="#archiveModal" data-id="2">
                        <i class="bi bi-archive"></i>
                    </button>
                </div>
            </div>
